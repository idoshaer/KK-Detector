...
mod_title = '16QAM Through Fiber and CDC';
y_limits = [1e-4 1];
figure(1)
...
% display_constellation_16QAM(y_CDC,constellation_title)
figure(7)
constellation_title = '16QAM: Downsampled to Digital Level';  
display_constellation_16QAM(down_sampled_2,constellation_title)
