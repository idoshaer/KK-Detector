...
%%%%%%%%%%%%%%%%%%%%%%%
% This program creates srrc shaped 64QAM signals and transmits them through 
...
for i = 1:SNR_limit_value
    ...
    [bssI_1_rx,bssI_2_rx,bssI_3_rx,bssQ_1_rx,bssQ_2_rx,bssQ_3_rx] = decision64qam(down_sampled_2);
...
mod_title = '64QAM Through Fiber and CDC';
y_limits = [1e-4 1];
figure(1)
...
% display_constellation_64QAM(y,constellation_title)
% figure(4)
...
% display_constellation_64QAM(y_CDC,constellation_title)
figure(7)
constellation_title = '64QAM: Downsampled to Digital Level';  
display_constellation_64QAM(down_sampled_2,constellation_title)
