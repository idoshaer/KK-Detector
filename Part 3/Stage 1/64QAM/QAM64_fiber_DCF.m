...
%%%%%%%%%%%%%%%%%%%%%%%
% This program creates srrc shaped 64QAM signals and transmits them through an optical fiber with dispersion and DCF.
...
figure(3)
constellation_title = '64QAM: transmission of the signal through the first optical fiber';  
display_constellation_64QAM(y,constellation_title)
figure(4)
constellation_title = '64QAM: transmission of the signal through the DCF';  
display_constellation_64QAM(y_DCF,constellation_title)
