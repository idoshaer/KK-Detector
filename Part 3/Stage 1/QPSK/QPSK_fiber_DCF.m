...
mod_title = 'QPSK Through Fiber and DCF';
y_limits = [1e-6 1];
figure(1)
...
figure(3)
constellation_title = 'QPSK: Transmission of the Signal Through the First Optical Fiber';  
display_constellation_QPSK(y,constellation_title)
figure(4)
constellation_title = 'QPSK: Transmission of the Signal Through the DCF';  
display_constellation_QPSK(y_DCF,constellation_title)
