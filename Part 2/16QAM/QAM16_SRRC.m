...
%%%%%%%%%%%%%%%%%%%%%%%
% This program calculates the BER and the SER numerically for srrc shaped 16QAM signals with different SNR values 
% in AWGN channel.
...
for i = 1:SNR_limit_value
    ...
    %%estimating the inphase and quadrature bits from the noisy signal 
...
mod_title = '16QAM Pulse Shaped Signal';
y_limits = [1e-4 1];
figure(1)
...
figure(3)
constellation_title = '16QAM: Pulse Shaped Signal With Noise';  
display_constellation_16QAM(r,constellation_title)
figure(4)
constellation_title = '16QAM: Downsampled Signal';  
display_constellation_16QAM(down_sampled,constellation_title)
